...
import com.novita.gd10_kelas_10745.databinding.ActivityDetailMahasiswaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEdit.setOnClickListener {
            startActivity(
                Intent(
                    this,
                    FormEditMahasiswaActivity::class.java
                ).apply {
                    putExtra("nim", nim)
                })
        }
    ...
    private fun doDeleteData(nim: String) {
        RClient.instances.deleteData(nim).enqueue(object :
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    Toast.makeText(applicationContext, "Data berhasil dihapus", Toast.LENGTH_LONG)
                        .show()
                    finish()
                }
            }
